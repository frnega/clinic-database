...
This is **Clinic database** project built with SQL includes data about patients, medical histories, treatments and invoices. We used a relational database to create the data structure for a clinic databse.
